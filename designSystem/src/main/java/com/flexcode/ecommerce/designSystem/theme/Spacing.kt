 ...
 * @property [bottomLarge] 120.dp the padding below in views to create a spacing at the bottom of the
 * screen especially in dashboard screen where there are is a bottom sheet
 */
data class Spacing(
    val none: Dp = 0.dp,
