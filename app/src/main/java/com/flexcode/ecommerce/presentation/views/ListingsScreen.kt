...
import com.flexcode.ecommerce.presentation.ListingItem
...
import com.flexcode.ecommerce.R.drawable as AppDrawable
...
fun ListingsScreenRoute(
    ...
    ListingScreen(state = state, onEvent = viewModel::onEvent, toDetails = toDetails)
}
...
fun ListingScreenPreview() {
    EcommerceTheme {
        ListingScreen(state = UiState(), onEvent = {}, toDetails = {})
    }
}
